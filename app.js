...
const handleStage2Submit = () => {
    ...
    setTimeout(() => {
        transitionStage(2, 3);
        // Start plotting the heart curve
...
function transitionStage(fromStage, toStage) {
    ...
    const fromCard =
        document.getElementById(`stage-${fromStage}`);
    const toCard =
        document.getElementById(`stage-${toStage}`);
...
function triggerTypewriterEffect() {
    // Changed from Pawwwwww to Tayyyyy
